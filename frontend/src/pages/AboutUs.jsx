  ...
  return (
    <div className="flex flex-col items-end gap-14 mb-20">
      ...
      <div className="flex items-center w-[90%]">
        <p className="w-[95%] text-[15px] text-[#666]">
      ...
      <div className="w-[90%] text-[26px] text-[#333] font-semibold">
        <h1>Why Choose Us?</h1>
      </div>
      <div className="w-[90%] flex flex-col gap-6 text-[#666] ">
        <div className=" w-[90%] font-[500] text-[15px] ">
        ...
        <div className="font-[500] text-[15px] w-[90%]">
          ...
          <span className="  font-[700]"> Contact page</span>.
        </div>
      </div>
    </div>
  );
