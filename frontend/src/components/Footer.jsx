...
const Footer = () => {
  return (
    <div className="bg-black text-white">
      <div className="sm:w-[85%] w-[90%] mx-auto flex md:flex-row flex-col md:items-center gap-10 py-16">
        ...
        <div className="md:w-[40%] flex sm:flex-row flex-col gap-4">
          <div className="sm:w-1/2">
            <div className="text-[#ca8b2b] text-xl font-semibold">
              Quick Links
            </div>
            <nav className="flex flex-col font-medium gap-3 text-sm mt-8">
              <NavLink
                to="/peptides"
                className="hover:text-[#9C6B2B] transition-all duration-500 ease-in-out"
              >
                Peptides for Sale
              </NavLink>
              <NavLink
      ...
      <div className="bg-[#141313] w-[100%] flex items-center justify-center text-sm py-8 text-[#ca8b2b]">
