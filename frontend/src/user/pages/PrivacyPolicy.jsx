...
const PrivacyPolicy = () => {
  return (
    <div className="flex flex-col items-end gap-14 mb-20">
      ...
      >
        <h1 className="md:ml-28 md:mt-8 mt-4 w-[90%] text-gradient md:text-[60px] text-[32px] leading-tight font-[700]">
          PRIVACY POLICY
        </h1>
      </div>
        ...
        <div className="flex flex-col gap-6 items-start md:w-[80%] w-[90%] text-[#666]">
          <div className="flex flex-col gap-5 ">
            ...
            <p>
              ...
              Policy has been created with the help of a Privacy Policy
              Generator.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <ul className="decoration-dotted list-disc pl-5 flex flex-col gap-4">
              ...
              <li>
                ...
                Cookies to test new advertisements, pages, features or new
          ...
          <ul className="decoration-dotted list-disc pl-5 flex flex-col gap-4">
            <li>
              <span className="font-bold">Google Analytics</span> Google
